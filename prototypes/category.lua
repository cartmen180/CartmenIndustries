...
--Item Groups
  ...
  {type = "item-subgroup", name = "ci-copper", group = "ci-ores", order = "c-a"},
  {type = "item-subgroup", name = "ci-coal", group = "ci-ores", order = "c-b"},
  ...
  {type = "item-subgroup", name = "ci-zinc&nickel", group = "ci-ores", order = "g"},
